...
#     """
#     Read each sheet's Row 8 field-description text and pull out which
#     technical fields (matched against Row 5) are marked mandatory.

#     The template marks a mandatory field with a trailing '*' on the first
#     line of its description, e.g. 'Company Code*\n\nThe company code is...'.
#     Parsing this directly from the template (rather than hardcoding a list)
#     means the mandatory set always matches whatever template is actually
#     loaded, even if it's updated later.

#     Returns: dict of {technical_field_name: human_readable_label}
#     """
#     mandatory = {}
